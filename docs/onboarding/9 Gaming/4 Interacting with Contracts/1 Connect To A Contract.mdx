...
If you're using the [Marketplace](/pre-built-contracts/marketplace) or [Pack](/pre-built-contracts/pack), you can access that in the contract's `marketplace` and `pack` fields:
